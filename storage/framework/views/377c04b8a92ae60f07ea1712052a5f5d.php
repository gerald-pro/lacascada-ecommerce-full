    ...
    >
        <div>
            <button
                ...
                <?php if($component->isFilterLayoutPopover()): ?> x-on:click="filterPopoverOpen = !filterPopoverOpen"
                    aria-haspopup="true"
                    x-bind:aria-expanded="filterPopoverOpen"
                    aria-expanded="true"
                <?php endif; ?>
                <?php if($component->isFilterLayoutSlideDown()): ?> x-on:click="filtersOpen = !filtersOpen" <?php endif; ?>
            >
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'livewire-tables::components.tools.toolbar.items.filter-popover','data' => ['filterGenericData' => $filterGenericData]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php /**PATH C:\laragon\www\lacascada-ecommerce\vendor\rappasoft\laravel-livewire-tables\resources\views\components\tools\toolbar\items\filter-button.blade.php ENDPATH**/ ?>