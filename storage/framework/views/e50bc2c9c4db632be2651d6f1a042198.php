                ...
                >
                    <div wire:key="<?php echo e($tableName); ?>-columnSelect-selectAll-<?php echo e(rand(0,1000)); ?>">
                        ...
                        >
                            ...
                            >
                            <span class="ml-2"><?php echo e(__('All Columns')); ?></span>
                        </label>
                    </div>

                    <?php $__currentLoopData = $component->getColumnsForColumnSelect(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $columnSlug => $columnTitle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\lacascada-ecommerce\vendor\rappasoft\laravel-livewire-tables\resources\views\components\tools\toolbar\items\column-select.blade.php ENDPATH**/ ?>