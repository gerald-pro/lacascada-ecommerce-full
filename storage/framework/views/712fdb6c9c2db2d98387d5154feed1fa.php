                ...
                <ul class="text-sm">
                    <?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li><a class="flex items-center p-2 text-slate-800 dark:text-slate-100 hover:text-white hover:bg-indigo-500 rounded group"
                                href="<?php echo e($result['url']); ?>"><?php echo e($result['title']); ?></a></li>
...
</div><?php /**PATH C:\laragon\www\lacascada-ecommerce\resources\views\livewire\global-searcher.blade.php ENDPATH**/ ?>