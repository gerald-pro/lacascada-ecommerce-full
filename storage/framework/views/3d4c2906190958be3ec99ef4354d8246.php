    ...
    <header>
        <a href="<?php echo e(route('products.show', $product)); ?>">
            <span class="rounded-t-lg featured-post-image" role="img"
                style="background-image: url('<?php echo e($product->image_url); ?>');" alt="Featured Image"></span>
        </a>
    </header>
        ...
        <div class="mt-auto flex flex-col space-y-2">
            ...
            <?php if($product->price || $product->price > 0): ?>
                ...
                <div class="w-full flex justify-between items-center">
                    <?php if($product->currentPromotion): ?>
                        <span class="text-md line-through text-red-700">Bs. <?php echo e($product->price); ?></span>
                    ...
                    <?php else: ?>
                        <span class="text-lg">Bs. <?php echo e($product->price); ?></span>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
        </div>
...
<?php /**PATH C:\laragon\www\lacascada-ecommerce\resources\views\components\product-card.blade.php ENDPATH**/ ?>